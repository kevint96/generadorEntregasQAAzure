...
def main():
    ...
    if st.button("📄 Generar documentos"):
        ...
        elif not nombre_servicio.strip() or not operacion.strip() or not nombre_autor.strip() or not id_iniciativa.strip() or not num_hrv.strip() or not prueba or not aut_puntual or not aut_prod:
